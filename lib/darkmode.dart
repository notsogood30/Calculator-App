...
class mydarkmode extends StatefulWidget {
  @override
  _mydarkmodeState createState() => _mydarkmodeState();
}

class _mydarkmodeState extends State<mydarkmode> {
  String myequation ='0';
  Parser p = Parser();
  Expression exp;
  String n ='0';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text('$n', style: TextStyle(color: Colors.white,decoration: TextDecoration.none,fontSize: 60))
                      ],
                    ),
            ...
            Expanded(
              child: Container(
                child: GridButton(borderColor: Color(0xff374353), items: [
                  [
                    GridButtonItem(
                      child: Container(
                        height: 70,
                        ...
                        child: FloatingActionButton(
                            ...
                            elevation: 10.0,
                            backgroundColor: Color(0xff374353),
